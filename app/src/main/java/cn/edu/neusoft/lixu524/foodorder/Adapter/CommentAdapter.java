...
public class OrderAdapter extends BaseAdapter<OrderBean>{
    ...
    public OrderAdapter(Context context, List<OrderBean> items, int layoutResource) {
        super(context, items, layoutResource);
        this.context=context;
    }

    public void setList(List<OrderBean> l){
        items=l;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final OrderBean bean = items.get(position);
        if(bean==null) return;
